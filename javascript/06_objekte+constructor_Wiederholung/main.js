...
var jamesDoe = new SkillsCreator(`James`, `Doe`, 2, 2, 1);
...
var Users = function(myFirstName, myLastName, myUserName) {
    this.firstName = myFirstName;
    this.lastName = myLastName;
    this.userName = myUserName;
    this.welcome = function() {
        console.log(`Hello ${this.firstName} ${this.lastName}, your Username is "${this.userName}" and you are welcome!`);
    }
}

var testperson = new Users(`Vorname`, `Nachname`, `Test-User`);

console.log(testperson.welcome());